...
# Create levelplot
levelplot(value ~ amount_station_out*variable, data=df_results_grouped_long  ,xlab="Number of stations out",
          ylab = "Different stations",
          #main="Performance of the RMSE at different stations with increasing number of stations left out",
