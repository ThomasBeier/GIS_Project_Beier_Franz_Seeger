...
rootDir = "~/edu/GIS_Project_Beier_Franz_Seeger"  
...
```{r eval = FALSE, echo=FALSE, warning=FALSE, fig.width=12, fig.height=7}
par_org <- par()
...
```{r eval = FALSE, echo=FALSE, warning=FALSE, fig.width=10, fig.height=7}
...
```{r eval = FALSE, echo=FALSE, warning=FALSE, fig.width=10, fig.height=5}
...
model_results <- function(training_data,testing_data,wiese_validation,
  ...
  #'@param validation_runs Number of runs the model will be excecuted for the same 
