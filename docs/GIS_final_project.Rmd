...
df_rmse_gesamt_mean <- summarize(df_full_results_grouped,
                                 rmse_gesamt_mean = round(mean(rmse_gesamt), 2),
                                 rmse_gesamt_sd = round(sd(rmse_gesamt), 2))
...
ggplot(df_rmse_gesamt_mean, aes(x = amount_station_out, y = rmse_gesamt_mean)) +
  ...
  geom_errorbar(aes(x = amount_station_out,
                    ymin = rmse_gesamt_mean-rmse_gesamt_sd,
                    ymax = rmse_gesamt_mean+rmse_gesamt_sd),
                width = 0.5, size = 0.8)
