...
ggplot(df_rmse_gesamt_mean, aes(x = amount_station_out, y = rmse_wiese_mean)) +
  ...
  labs(x = "Number of stations left out", y = "Mean RMSE") + 
...
ggplot(df_full_results, aes(x = amount_station_out, y = rmse_wiese_station)) +
  geom_boxplot() +
  labs(x = "Number of stations left out", y = "RMSE")
...
# Create levelplot
levelplot(value ~ amount_station_out*variable, data=df_results_grouped_long  ,xlab="Number of stations left out",
          ylab = "Treetalker stations",
          col.regions = cols)
...
ggplot(mean_each_station, aes(x=Group.1, y=mean_v)) + 
  ...
  xlab("Number of stations left out")+
  ylab("Mean RMSE")+
