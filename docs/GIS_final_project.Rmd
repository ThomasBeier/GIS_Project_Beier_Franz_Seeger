...
model_results <- function(training_data,testing_data,wiese_validation,nr_stations_out,first_seed,second_seeds,validation_runs,rounding = 2){
  #'@title model_results.
...
result <- model_results(training,testing,df_predictors_wiese_merged,2,98,c(64,13,649),3,2)
...
result <- model_results(training,testing,df_predictors_wiese_merged,2,42,c(29,18,98),3,2)
...
result <- model_results(training,testing,df_predictors_wiese_merged,2,12,c(6,81,45),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,2,75,c(46,87,38),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,2,97,c(53,3,76),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,2,8,c(29,85,5),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,2,531,c(12,21,82),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,2,35,c(91,25,55),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,14,11,c(54,12,95),3,2)

df_full_results <- rbind(df_full_results, result)

# 8 stations removed  
result <- model_results(training,testing,df_predictors_wiese_merged,8,67,c(41,53,19),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,8,81,c(61,28,43),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,8,80,c(2,51,78),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,8,103,c(70,99,19),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,8,19,c(25,5,95),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,8,49,c(20,76,14),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,8,57,c(91,12,75),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,8,15,c(82,22,33),3,2)

df_full_results <- rbind(df_full_results, result)

# 16 Stations removed
result <- model_results(training,testing,df_predictors_wiese_merged,16,97,c(23,18,37),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,16,9,c(65,50,7),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,16,53,c(12,75,14),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,16,86,c(86,91,71),3,2)

df_full_results <- rbind(df_full_results, result)

result <- model_results(training,testing,df_predictors_wiese_merged,16,100,c(25,19,79),3,2)
...
ggplot(df_rmse_gesamt_mean, aes(x = amount_station_out, y = rmse_gesamt_mean)) +
  ...
  scale_x_discrete(limits = c(2,8,14,16)) + 
...
ggplot(df_full_results, aes(x = amount_station_out, y = rmse_gesamt)) +
  geom_boxplot() +
